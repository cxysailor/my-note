...
#   File Name     : axis_limit_scale_orientation.py
#   Last Modified : 2024-07-03 17:17
#   Describe      : 
#
# ====================================================
...
for i, t in enumerate(range(100)):
    ws.append([t / 16.0, 
          "=$A${row}*COS($A${row})".format(row = i + 3),
...
chart4.y_axis.scaling.orientation = "minMax"
...
wb.save(filename="orientation.xlsx")
wb.close()
